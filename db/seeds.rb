...
C4dSubcategory.create(title: 'Behavioural Goal', c4d_category_id: 1)
C4dSubcategory.create(title: 'Using Evidence', c4d_category_id: 1)
C4dSubcategory.create(title: 'ID High Risk Groups', c4d_category_id: 1)
C4dSubcategory.create(title: 'Segmentation', c4d_category_id: 2)
C4dSubcategory.create(title: 'Barriers', c4d_category_id: 2)
C4dSubcategory.create(title: 'Messaging', c4d_category_id: 2)
C4dSubcategory.create(title: 'ID Your Scenario', c4d_category_id: 2)
C4dSubcategory.create(title: 'The Global Strategy', c4d_category_id: 3)
C4dSubcategory.create(title: 'Integrated Action', c4d_category_id: 3)
C4dSubcategory.create(title: 'Capacity Building', c4d_category_id: 3)
C4dSubcategory.create(title: 'Monitor Evaluate', c4d_category_id: 3)
C4dSubcategory.create(title: 'Mass Media IEC', c4d_category_id: 4)
C4dSubcategory.create(title: 'Training', c4d_category_id: 4)
C4dSubcategory.create(title: 'Management Tools', c4d_category_id: 4)
C4dSubcategory.create(title: 'Innovations', c4d_category_id: 4)
C4dSubcategory.create(title: 'Channel Analysis', c4d_category_id: 4)
