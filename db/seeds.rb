...
SopArticle.create(title: 'awesome_title', sop_time_id: 2, CMS_title: 'awesome_title')
SopArticle.create(title: 'awesome_title2', sop_time_id: 3, CMS_title: 'awesome_title2')
SopArticle.create(title: 'awesome_title3', sop_time_id: 4, CMS_title: 'awesome_title3')
SopArticle.create(title: 'awesome_title4', sop_time_id: 4, CMS_title: 'awesome_title4')
SopArticle.create(title: 'awesome_title5', sop_time_id: 2, CMS_title: 'awesome_title5')
SopArticle.create(title: 'awesome_title6', sop_time_id: 4, CMS_title: 'awesome_title6')
SopArticle.create(title: 'awesome_title7', sop_time_id: 5, CMS_title: 'awesome_title7')
