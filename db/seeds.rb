...
C4dArticle.create(title: 'awesome_title', c4d_category_id: 1, c4d_subcategory: 1, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title2', c4d_category_id: 1, c4d_subcategory: 2, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title3', c4d_category_id: 1, c4d_subcategory: 3, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title4', c4d_category_id: 2, c4d_subcategory: 4, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title5', c4d_category_id: 2, c4d_subcategory: 5, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title6', c4d_category_id: 2, c4d_subcategory: 6, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title7', c4d_category_id: 2, c4d_subcategory: 7, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title8', c4d_category_id: 2, c4d_subcategory: 8, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title9', c4d_category_id: 3, c4d_subcategory: 9, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title10', c4d_category_id: 3, c4d_subcategory: 10, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title11', c4d_category_id: 3, c4d_subcategory: 11, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title12', c4d_category_id: 4, c4d_subcategory: 12, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title13', c4d_category_id: 4, c4d_subcategory: 13, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title14', c4d_category_id: 4, c4d_subcategory: 14, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
C4dArticle.create(title: 'awesome_title15', c4d_category_id: 4, c4d_subcategory: 15, owner_id: user.id, description: 'foobar', CMS_title: 'awesome_title')
